        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <img
                src="/path-to-image.jpg" // Update this path
                alt="Sanskar Yadav"
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {["15m", "30m", "45m", "60m"].map((duration) => (
                      <button
                        ...
                        className={`px-3 py-1 text-sm rounded-md transition-colors ${selectedDuration === duration
            ...
            <div className="bg-white rounded-lg shadow-sm border border-grey-container">
              ...
              <div className="p-4">
                {selectedView === "monthly" && (
                  <MonthlyView onTimeSelect={handleTimeSelect} onConfirm={handleBookingConfirm} />
                )}
                {selectedView === "weekly" && (
                  <WeeklyView onTimeSelect={handleTimeSelect} onConfirm={handleBookingConfirm} />
                )}
              </div>
            </div>
          </div>
